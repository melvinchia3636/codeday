...
export function Signup() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={topLineRef}
        className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-500 via-fuchsia-500 to-pink-500 origin-left"
      ></div>
      <div
        ref={bottomLineRef}
        className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-pink-500 via-fuchsia-500 to-cyan-500 origin-right"
      ></div>
      ...
      <div className="relative z-10 w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <p className="text-cyan-300/60 text-sm tracking-[0.3em] flex items-center justify-center gap-2">
            <Icon icon="pixelarticons:code" className="w-4 h-4" />{" "}
            IDENTITY_CREATION v2.0{" "}
            <Icon icon="pixelarticons:code" className="w-4 h-4" />
          </p>
        </div>
        ...
        <div className="relative" style={{ perspective: "1000px" }}>
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-500 via-fuchsia-500 to-transparent"></div>
        ...
        <div className="mt-6 flex justify-center gap-2">
          {[...Array(5)].map((_, i) => (
            <div
              ...
              style={{
                backgroundColor:
                  i === 2 ? "rgba(34,211,238,0.5)" : "transparent",
                opacity: 0,
              }}
            ></div>
          ))}
      ...
      {[...Array(4)].map((_, i) => (
        <div
          ...
          className={`absolute w-6 h-6 border-cyan-500 ${
            i === 0
