    ...
    <>
      <div className="relative" style={{ perspective: "1000px" }}>
        ...
        <div
          ...
          style={{ opacity: 0 }}
        >
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-pink-500 via-fuchsia-500 to-transparent" />
          ...
          <div className="mt-8 text-center form-element" style={{ opacity: 0 }}>
            <p className="text-xs text-zinc-500 flex items-center justify-center gap-2">
              <Icon icon="pixelarticons:user" className="w-4 h-4" /> NO_ACCOUNT?{" "}
              <Link
                to="/signup"
      ...
      <div className="mt-6 flex justify-center gap-2">
        {[...Array(5)].map((_, i) => (
          <div
            ...
            style={{
              backgroundColor: i === 2 ? "rgba(236,72,153,0.5)" : "transparent",
              opacity: 0,
            }}
          />
        ))}
