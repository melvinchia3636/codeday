...
export const createHealthRoutes = (pb: PocketBase): Router => {
  ...
  router.post('/daily-summaries', authMiddleware, validate(createDailySummarySchema), (req, res, next) =>
    dailySummaryController.create(req as AuthenticatedRequest, res, next)
  );
  router.put('/daily-summaries', authMiddleware, validate(updateDailySummarySchema), (req, res, next) =>
    dailySummaryController.update(req as AuthenticatedRequest, res, next)
  );
  ...
  router.post('/me', validate(createUserProfileSchema), (req, res, next) =>
    profileController.create(req as AuthenticatedRequest, res, next)
  );
  ...
  router.post('/waifu/greeting', authMiddleware, validate(setWaifuGreetingSchema), (req, res, next) =>
    waifuController.setGreeting(req as AuthenticatedRequest, res, next)
  );
  router.put('/waifu/greeting', authMiddleware, validate(setWaifuGreetingSchema), (req, res, next) =>
    waifuController.updateGreeting(req as AuthenticatedRequest, res, next)
  );
  ...
  router.post('/water-logs/amount', authMiddleware, validate(createWaterLogSchema), (req, res, next) =>
    waterLogController.create(req as AuthenticatedRequest, res, next)
  );
  router.put('/water-logs/amount', authMiddleware, validate(updateWaterLogSchema), (req, res, next) =>
    waterLogController.update(req as AuthenticatedRequest, res, next)
  );
  ...
  router.post('/weight-targets', authMiddleware, validate(createWeightTargetSchema), (req, res, next) =>
    weightTargetController.create(req as AuthenticatedRequest, res, next)
  );
  router.put('/weight-targets', authMiddleware, validate(updateWeightTargetSchema), (req, res, next) =>
    weightTargetController.update(req as AuthenticatedRequest, res, next)
  );
  ...
  router.post('/workouts/effort-units', authMiddleware, validate(createWorkoutSchema), (req, res, next) =>
    workoutController.create(req as AuthenticatedRequest, res, next)
  );
  router.put('/workouts/effort-units', authMiddleware, validate(updateWorkoutSchema), (req, res, next) =>
    workoutController.update(req as AuthenticatedRequest, res, next)
  );
